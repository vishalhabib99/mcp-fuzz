...
Static analysis can't see any of that. Only running the code can. It also measures the one thing static analysis structurally can't: how long each tool actually takes to respond — see [Latency check](#latency-check) below.
